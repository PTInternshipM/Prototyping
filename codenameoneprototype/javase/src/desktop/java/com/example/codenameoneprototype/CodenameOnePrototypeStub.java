 ...
 * @author Shai Almog
 */
public class CodenameOnePrototypeStub implements Runnable, WindowListener {
    private static final String APP_TITLE = "Hi World";
    private static final String APP_NAME = "CodenameOnePrototype";
    ...
    private CodenameOnePrototype mainApp;
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(new CodenameOnePrototypeStub());
    }
        ...
        Display.getInstance().callSerially(new Runnable() {
            ...
            public void run() {
                if(Display.getInstance().isEdt()) {
                    mainApp = new CodenameOnePrototype();
                    mainApp.init(this);
                    mainApp.start();
